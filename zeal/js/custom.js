...
// Open chatbot when the "Chat" button is clicked
...
// Close chatbot when mouse leaves the chatbot container
document.getElementById('chatbot').addEventListener('mouseleave', function() {
    document.getElementById('chatbot').style.display = 'none';
});
...
document.getElementById('send-btn').addEventListener('click', function() {
    ...
    if (userInput.trim() !== "") {
        ...
        // Simulate bot response (for now, can be replaced with AI integration later)
        setTimeout(function() {
